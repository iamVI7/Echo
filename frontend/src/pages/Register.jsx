    ...
    <div className="min-h-screen bg-[var(--bg)] flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="font-display text-2xl font-medium text-ink-900">Begin your Echo</h1>
          <p className="text-sm text-[var(--text-muted)] mt-1 font-mono">A quiet space for your future self.</p>
        </div>
